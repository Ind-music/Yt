...
def audio_markup(user_id):
  buttons = [
    [
      InlineKeyboardButton(text="➷ 𝐔𝗽𝗱𝗮𝘁𝗲𝐒 ➹", url=f"https://t.me/kittu_support"),
      InlineKeyboardButton(text="➹ 𝐒𝘂𝗽𝗽𝗼𝗿𝐓 ➷", url=f"https://t.me/kittu_support"),
    ],
    [
      InlineKeyboardButton(text="❣️ 𝐐𝐮𝐞𝐞𝐧'𝘅𝗗 ❣️", url=f"https://t.me/Betuji_baccha"),
    ],
    [
